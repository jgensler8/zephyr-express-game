...
ASSETS = train_map_0.png train_player_logo_arrow.png bg_train_passenger.png task_sprite_modifier.png tasks.png cursor.png customer_status.png map_progress.png font_alphabet.png font_numeric.png $(ASSETS_PER_PLAYER) $(ASSETS_TOOLS) $(ASSETS_PLAYER_LOGOS)
ASSET_IN = assets
ASSETS_DEP = $(addprefix assets/,$(ASSETS))
PNG2ASSET_OUT = src/gen
ASSETS_OUT = $(addprefix $(PNG2ASSET_OUT)/,$(ASSETS:.png=.c))
HEADERS_CORE = input.h scenes.h types.h font.h sound.h
SRCS_CORE = input.c scene_gameplay.c scene_tutorial.c scene_difficulty_select.c scene_main_menu.c scene_upgrade_menu.c font.c sound.c main.c
...
$(ASSETS_OUT): $(ASSETS_DEP)
	...
	$(PNG2ASSET) $(ASSET_IN)/font_numeric.png -o $(PNG2ASSET_OUT)/font_numeric.c $(ASSET_ARGS_BKG) $(ASSET_BANK_ARG)
